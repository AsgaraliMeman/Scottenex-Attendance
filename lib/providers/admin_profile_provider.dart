...
///
/// Handles all business logic and data management for the Admin Profile Screen.
/// Separates UI concerns from business logic.
class AdminProfileProvider extends ChangeNotifier {
  final AuthProvider authProvider;

  // ============ Constants ============
  static const String defaultDesignation = 'System Administrator';
  static const String defaultEmail = 'admin@company.com';

  AdminProfileProvider({required this.authProvider});
